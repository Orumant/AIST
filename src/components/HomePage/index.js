...
class HomePage extends React.Component {
  ...
  render() {
    const overlayTooltip = (
      <Tooltip placement='top' id='wrongDomainTooltip'>
        Портал статистики доступен только в домене ALPHA
      </Tooltip>
    );
        ...
        <Grid>
          <Row className={'column'}>
            <Col md={3} className={'menu-element-header'}>
              ...
              <Thumbnail style={{position: 'relative', marginTop: '49px', border: 'none'}} href="#/launcher"
                         alt="171x180" src={Start}/>
            </Col>
            <Col md={3}>
